      ...
      >
        ...
        data-aos-delay="200">
          ...
          <h1 className="home-hero-title">
            Descubrí lo que tenemos para tu mascota
          </h1>
          <p>
      ...
      <section className="feature-showcase py-5 bg-light">
        <Container>
          ...
          <Row className="mb-5 text-center">
            ...
            >
              <img
                src="https://img.aosomcdn.com/thumbnail/100/n0/product/2023/11/14/PaT42b18bccca1f0c.jpg.webp"
                alt="Cuidado mascota"
                className="img-fluid rounded mb-3"
              />
              <h5>Proper Pet Care</h5>
              <p>
                Tenemos los mejores productos para tu mascota. ¡Visitá nuestra
                tienda hoy mismo!
              </p>
            </Col>
            <Col
            ...
            >
              <img
                src="https://m.media-amazon.com/images/I/81HYU4s7e5L.jpg"
                alt="Accesorios"
                className="img-fluid rounded mb-3"
              />
              <h5>Pet Accessories</h5>
              <p>
                Desde comederos hasta juguetes. Todo lo que tu mascota necesita,
                en un solo lugar.
              </p>
            </Col>
            <Col
            ...
            >
              <img
                src="https://www.eastwestbasics.com/wp-content/uploads/Pet-Products.jpg"
                alt="Veterinaria"
                className="img-fluid rounded mb-3"
              />
